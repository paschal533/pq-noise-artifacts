# Negative control A, re-run with the matrix run 20260917T102958Z

Control A re-run alongside the matrix in
[`../../results/20260917T102958Z/`](../../results/20260917T102958Z/), to show that its pass
...
**Change.** The TypeScript implementation at `c8a07cf`, with one constant reverted: the protocol
name set back to the old, hyphenated `Noise_XXhfs_25519+ML-KEM-768_ChaChaPoly_SHA256`. Nothing
else changed, and the change was not committed. Python (`8e12d013`), Nim (`eeff625`) and Rust
(`b68fe10`) were unchanged, using `Noise_XXhfs_25519+MLKEM768_ChaChaPoly_SHA256`.
