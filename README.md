...
| `interop/results/20260917T134954Z/` | the matrix run: `matrix.md`, `results.tsv`, `versions.txt` and all 96 per-run logs (the earlier runs `20260917T015709Z` and `20260917T102958Z`, superseded, are kept beside it) |
| `interop/negative-controls/20260917T134954Z/`, `interop/negative-controls/20260917/` | two negative controls showing the matrix checks can fail (control A re-run with the matrix run above in the first; control B in the second; `interop/negative-controls/20260917T102958Z/` holds control A for the superseded run `20260917T102958Z`) |
...
Run directory: [`interop/results/20260917T134954Z/`](interop/results/20260917T134954Z/). Runner:
...
**Negative controls** (control A: [`interop/negative-controls/20260917T134954Z/`](interop/negative-controls/20260917T134954Z/); control B, from the earlier run `20260917T015709Z`: [`interop/negative-controls/20260917/`](interop/negative-controls/20260917/)).
